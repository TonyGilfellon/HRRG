...
savepath = r'C:\Users\zup98752\OneDrive - Science and Technology Facilities Council\HRRG\HRRG_measurements_20240123\analysis'
snp_addr = r'C:\Users\zup98752\OneDrive - Science and Technology Facilities Council\HRRG\HRRG_measurements_20240123\data'
pkl_addr = r'C:\Users\zup98752\OneDrive - Science and Technology Facilities Council\HRRG\HRRG_measurements_20240123'
...
if read_data:
    ...
    for f in fnames:
        ...
        beta = hmm.get_beta(s11, overcoupled=True)
...
temp_corrected_freq_list = [res_freq_list[i]+(delta_freq_per_degree_Hz*temp_delta_list[i]) if np.abs(temp_delta_list[i])>0.0 else res_freq_list[i] for i in range(len(res_freq_list)) ]
